...
func addHipsterLookup() {
	...
	AddLookupData("hipsterparagraph", Info{
		...
		Output:      "string",
		Params: []Param{
			{Field: "paragraphcount", Type: "int", Default: "20", Description: "Number of paragraphs"},
			{Field: "sentencecount", Type: "int", Default: "20", Description: "Number of sentences in a paragraph"},
			{Field: "wordcount", Type: "int", Default: "50", Description: "Number of words in a sentence"},
